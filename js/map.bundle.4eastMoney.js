! function(e) {
    ...
    1: function(e, t) {
        ...
        function c(e, t, c, n) {
            // var d = a(t);
            //鍙栨秷devicePixelRatio瀵筩anvas鐨勭浉搴旂殑璁剧疆
            var d = 1;
                ...
                l.abort(), l = $.ajax({
                    ...
                    success: function(t) {
                        ...
                        for(var idx = 0; idx < stockList.length; idx++){
                            ...
                            //var key = stockList[i].f12 + postFix; // 杩欎釜鏄娇鐢ㄨ偂绁ㄤ唬鐮佸仛key
                            var key = stockList[idx].f14.replace(/\s/g,"")  //杩欎釜鏄娇鐢ㄨ偂绁ㄥ悕瀛楀仛key
        ...
        var c = a(0),
            ...
            d = React.createClass({
                ...
                render: function() {
                    ...
                    }, "Use mouse wheel to zoom in and out. Drag zoomed map to pan it. Double鈥慶lick a ticker to display detailed information in a new window.", React.createElement("br", null), !n.isWidget() && "Hover mouse cursor over a ticker to see its main competitors in a stacked view with a 3-month history graph."), React.createElement("td", {
                        className: "scale",
                        width: (s + 1) * d.length,
                        align: "right",
                        title: t,
            ...
            b = function() {
                ...
                return d(e, [{
                    ...
                    value: function(e, t) {
                        ...
                        //濡傛灉鏄痗hrome鍓囨渶灏忓瓧楂旀槸1px锛岃▓绠楁檪鏈€灏忓彧鑳芥寜1px瑷堢畻鈥斺€旇繖鏍峰彲浠ヤ娇鏀惧ぇ鏃舵樉绀烘洿澶氱殑鏂囧瓧
                    ...
                    value: function(e) {
                        ...
                        "Basic Materials" !== n.name && alert("bm fail"), "Healthcare" !== d.name && alert("h fail");
    ...
    90: function(e, t, a) {
        var c = a(9),
            ...
            l = React.createClass({
                ...
                _onChange: function() {
                    //console.log("榧犳爣鍦ㄨ涓氶棿鍒囨崲鐨勬椂鍊欎篃浼氳皟鐢ㄨ鏂规硶111")
                ...
                _onWheel: function(e) {
                    //console.log("榧犳爣婊氬姩鐨勬椂鍊欎細璋冪敤锛屼絾鏄湡闂寸Щ鍔ㄩ紶鏍囦篃浼氳皟鐢�....")
                    e.preventDefault();
                    var t = o(e),
                        a = t.offsetX,
                        c = t.offsetY;
                ...
                _initialize: function() {
                    //console.log("_initialize....鍒锋柊鍔犺浇鐨勬椂鍊欎細璋冪敤")
                    var e = this;
                ...
                _onShareMapClick: function(e) {
                    ...
                    s.src = d.logoBase64, s.onload = function() {
                        ...
                        r.fillText(f, d, 11), r.fillStyle = "#5faaf4", d -= Math.round(r.measureText(f).width), f = "鈥�", r.fillText(f, d, 11), r.fillStyle = "#4c5261", d -= Math.round(r.measureText(f).width), f = "  " + this.props.scale.name.toUpperCase() + "  ", r.fillText(f, d, 11), r.fillStyle = "#5faaf4", d -= Math.round(r.measureText(f).width), f = "鈥�", r.fillText(f, d, 11), r.fillStyle = "#4c5261", d -= Math.round(r.measureText(f).width), f = e + "  ", r.fillText(f, d, 11), r.drawImage(this._cache[1], 0, 0, t * o, (a - 22) * o, 0, 22, t, a - 22);
                        var l = i.toDataURL();
                        n.publishMap(l)
                    }.bind(this)
                }
    ...
    91: function(e, t, a) {
        var c = a(9),
            ...
            r = React.createClass({
                ...
                componentDidMount: function() {
                    //console.log("绗竴娆″姞杞芥椂浼氳皟鐢ㄥ埌璇ユ柟娉�")
                ...
                _onChange: function() {
                    //console.log("榧犳爣鍦ㄨ涓氶棿鍒囨崲鐨勬椂鍊欎篃浼氳皟鐢ㄨ鏂规硶")
                    this.setState({
