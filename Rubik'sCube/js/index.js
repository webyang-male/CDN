            ...
            if (this.state === PREPARING && this.dragTotal.length() > 0.05) {
                ...
                if (this.flipType === 'layer') {
                    ...
                    const axis = (this.dragDirection != 'x') ?
                        ((this.dragDirection == 'y' && position.current.x > this.game.world.width / 2) ? 'z' :
                            'x') :
                        'y';
    ...
    rotateLayer(rotation, scramble, callback) {
        ...
        this.rotationTween = new Tween({
            ...
            onComplete: () => {
                ...
                this.game.cube.object.rotation.setFromVector3(this.snapRotation(this.game.cube.object.rotation
                    .toVector3()));
            ...
            this.tweens.range[tweenId++] = new Tween({
                ...
                onUpdate: tween => {
                    ...
                    track.style.transform =
                        `translate3d(0, ${translate}em, 0) scale3d(${scale}, 1, 1)`;
            ...
            this.tweens.range[tweenId++] = new Tween({
                ...
                onUpdate: tween => {
                    ...
                    handle.style.transform =
                        `translate3d(0, ${translate}em, 0) scale3d(${scale}, ${scale}, ${scale})`;
...
class Particle {
    ...
    reset(randomHeight = true) {
        ...
        this.mesh.rotation.set(Math.random() * Math.PI / 3, Math.random() * Math.PI / 3, Math.random() * Math.PI /
            3);
...
class IconsConverter {
    ...
    addStyles() {
        ...
        style.innerHTML =
            `.${this.className} { display: inline-block; font-size: inherit; overflow: visible; vertical-align: -0.125em; preserveAspectRatio: none; }`;
